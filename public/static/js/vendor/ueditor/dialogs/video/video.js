    ...
    */
    function insertSingle(){
        ...
        if(url.indexOf('<iframe') != -1){
            ...
            /^[1-9]+[.]?\d*$/g.test( width.value ) ? newIframe.setAttribute("width",width.value) : newIframe.setAttribute("width", "100%");
            /^[1-9]+[.]?\d*$/g.test( height.value ) ? newIframe.setAttribute("height",height.value) : newIframe.setAttribute("height", "280");
    ...
    */
    function createPreviewVideo(url){
        ...
        if(url.indexOf('<iframe') != -1){
            ...
            $('#edui155_body').css("disabled","true");
        }
        $G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
